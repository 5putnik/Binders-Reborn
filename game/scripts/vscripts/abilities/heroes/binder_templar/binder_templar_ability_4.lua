...
function ExorcismPhysics( event )
	...
	local particleDamage = "particles/units/heroes/hero_wisp/wisp_guardian_explosion_small.vpcf"
	local particleDamageBuilding = "particles/units/heroes/hero_wisp/wisp_guardian_explosion_small.vpcf"
